...
@XTP-34886 @XTP-73592 @XTP-28348 @XTP-29227 @Team_HIMALAYA
Scenario Outline: TMC Subarray report the exception triggered by the SDP subarray when it encounters a duplicate eb-id/pb-id.
