...
@pytest.mark.SKA_low
@scenario(
    "../features/tmc/pst_scan_without_sdp.feature",
    "Successful Execution of PST Scan without SDP configuration on Low "
    + "Telescope Subarray in TMC",
)
def test_tmc_pst_scan_without_sdp_command():
    """BDD test scenario for verifying successful execution of
    the PST Scan without SDP configuration in TMC."""
