"""
Module: test_tmc_end_command with MCCS only configuration
...
@pytest.mark.SKA_low
@scenario(
    "../features/tmc/check_mccs_only_configure_end_command.feature",
    "Successful Execution of End Command on Low Telescope"
    + " Subarray with MCCS-Only Configuration in TMC",
)
def test_tmc_configure_command():
    """BDD test scenario for verifying successful execution of
    the Low End command in a TMC with MCCS only configuration."""
...
@given("I configure TMC subarray with MCCS only configuration")
...
@given("the TMC subarray transitions to the READY obsState")
