...
Abort Command of a Low Telescope Subarray in the Telescope Monitoring and
Control (TMC) system.
"""
import json
...
@scenario(
    ...
    "Successful Execution of Abort Command on Low Telescope Subarray in TMC",
)
def test_tmc_abort_command():
    """BDD test scenario for verifying successful execution of
    the Low Abort command in a TMC."""
...
def check_scan_completion(
    ...
    """Send abort command and verify that the subarray is in Aborted
    obsState."""
