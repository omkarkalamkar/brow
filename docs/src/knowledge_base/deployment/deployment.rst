...
^^^^^^^^^^^^^^
    ...
    #. **ScanStartTimeEnabled** :  This refers to the property provided to enable/disable start_time in Scan JSON. Currently defaults to true.
    #. **ScanDurationEnabled** :  This refers to the property provided to enable/disable duration in Scan JSON. Currently defaults to true.
